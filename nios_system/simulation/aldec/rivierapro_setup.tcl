...
# ACDS 13.0sp1 232 linux 2016.12.04.18:51:21
...
alias com {
  echo "\[exec\] com"
  vlog  "$QSYS_SIMDIR/submodules/altera_tristate_controller_aggregator.sv"                            -work tda                                                                              
  vlog  "$QSYS_SIMDIR/submodules/altera_tristate_controller_translator.sv"                            -work tdt                                                                              
  ...
  vlog  "$QSYS_SIMDIR/submodules/nios_system_rsp_xbar_demux_004.sv"                                   -work rsp_xbar_demux_004                                                               
  vlog  "$QSYS_SIMDIR/submodules/nios_system_rsp_xbar_demux_003.sv"                                   -work rsp_xbar_demux_003                                                               
  vlog  "$QSYS_SIMDIR/submodules/nios_system_rsp_xbar_demux_001.sv"                                   -work rsp_xbar_demux_001                                                               
  ...
  vlog  "$QSYS_SIMDIR/submodules/nios_system_cmd_xbar_mux_001.sv"                                     -work cmd_xbar_mux_001                                                                 
  ...
  vlog  "$QSYS_SIMDIR/submodules/nios_system_cmd_xbar_demux_002.sv"                                   -work cmd_xbar_demux_002                                                               
  ...
  vlog  "$QSYS_SIMDIR/submodules/nios_system_id_router_004.sv"                                        -work id_router_004                                                                    
  vlog  "$QSYS_SIMDIR/submodules/nios_system_id_router_003.sv"                                        -work id_router_003                                                                    
  vlog  "$QSYS_SIMDIR/submodules/nios_system_id_router_001.sv"                                        -work id_router_001                                                                    
  vlog  "$QSYS_SIMDIR/submodules/nios_system_id_router.sv"                                            -work id_router                                                                        
  vlog  "$QSYS_SIMDIR/submodules/nios_system_addr_router_002.sv"                                      -work addr_router_002                                                                  
  ...
  vlog  "$QSYS_SIMDIR/submodules/altera_customins_slave_translator.sv"                                -work nios2_qsys_0_custom_instruction_master_comb_slave_translator0                    
  vlog  "$QSYS_SIMDIR/submodules/nios_system_nios2_qsys_0_custom_instruction_master_comb_xconnect.sv" -work nios2_qsys_0_custom_instruction_master_comb_xconnect                             
  ...
  vlog  "$QSYS_SIMDIR/submodules/nios_system_tristate_conduit_bridge_0.sv"                            -work tristate_conduit_bridge_0                                                        
...
alias elab_debug {
  ...
  vsim -dbg -O2 +access +r -t ps -L work -L tda -L tdt -L irq_mapper -L crosser -L width_adapter -L rsp_xbar_mux_001 -L rsp_xbar_mux -L rsp_xbar_demux_004 -L rsp_xbar_demux_003 -L rsp_xbar_demux_001 -L rsp_xbar_demux -L cmd_xbar_mux_001 -L cmd_xbar_mux -L cmd_xbar_demux_002 -L cmd_xbar_demux_001 -L cmd_xbar_demux -L rst_controller -L burst_adapter -L limiter -L id_router_004 -L id_router_003 -L id_router_001 -L id_router -L addr_router_002 -L addr_router_001 -L addr_router -L nios2_qsys_0_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo -L nios2_qsys_0_jtag_debug_module_translator_avalon_universal_slave_0_agent -L nios2_qsys_0_instruction_master_translator_avalon_universal_master_0_agent -L nios2_qsys_0_jtag_debug_module_translator -L nios2_qsys_0_instruction_master_translator -L nios2_qsys_0_custom_instruction_master_comb_slave_translator0 -L nios2_qsys_0_custom_instruction_master_comb_xconnect -L nios2_qsys_0_custom_instruction_master_translator -L sysid_qsys_0 -L put_pixel_rows_hw_0 -L put_pixel_rows_0 -L ycc_rgb_convert_0 -L timer_0 -L switches -L gleds -L rleds -L performance_counter_0 -L tristate_conduit_bridge_0 -L generic_tristate_controller_0 -L video_vga_controller_0 -L video_dual_clock_buffer_0 -L video_rgb_resampler_0 -L video_pixel_buffer_dma_0 -L new_sdram_controller_0 -L jtag_uart_0 -L nios2_qsys_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver $TOP_LEVEL_NAME
}
