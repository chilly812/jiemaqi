...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/altera_tristate_controller_aggregator.sv"                            -work tda                                                                              
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/altera_tristate_controller_translator.sv"                            -work tdt                                                                              
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/nios_system_rsp_xbar_demux_004.sv"                                   -work rsp_xbar_demux_004                                                               
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/nios_system_rsp_xbar_demux_003.sv"                                   -work rsp_xbar_demux_003                                                               
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/nios_system_id_router_004.sv"                                        -work id_router_004                                                                    
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/nios_system_id_router_003.sv"                                        -work id_router_003                                                                    
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/nios_system_nios2_qsys_0_custom_instruction_master_comb_xconnect.sv" -work nios2_qsys_0_custom_instruction_master_comb_xconnect                             
  ...
  vlogan +v2k           "$QSYS_SIMDIR/submodules/put_pixel_rows_hw.v"                                                 -work put_pixel_rows_hw_0                                                              
  vlogan +v2k           "$QSYS_SIMDIR/submodules/put_pixel_rows.v"                                                    -work put_pixel_rows_0                                                                 
  vlogan +v2k           "$QSYS_SIMDIR/submodules/ycc_rgb_convert.v"                                                   -work ycc_rgb_convert_0                                                                
  vlogan +v2k           "$QSYS_SIMDIR/submodules/nios_system_timer_0.v"                                               -work timer_0                                                                          
  vlogan +v2k           "$QSYS_SIMDIR/submodules/nios_system_switches.v"                                              -work switches                                                                         
  vlogan +v2k           "$QSYS_SIMDIR/submodules/nios_system_gleds.v"                                                 -work gleds                                                                            
  vlogan +v2k           "$QSYS_SIMDIR/submodules/nios_system_rleds.v"                                                 -work rleds                                                                            
  vlogan +v2k           "$QSYS_SIMDIR/submodules/nios_system_performance_counter_0.v"                                 -work performance_counter_0                                                            
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/nios_system_tristate_conduit_bridge_0.sv"                            -work tristate_conduit_bridge_0                                                        
  vlogan +v2k           "$QSYS_SIMDIR/submodules/nios_system_generic_tristate_controller_0.v"                         -work generic_tristate_controller_0                                                    
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altera_up_avalon_video_vga_timing.v"                                 -work video_vga_controller_0                                                           
  vlogan +v2k           "$QSYS_SIMDIR/submodules/nios_system_video_vga_controller_0.v"                                -work video_vga_controller_0                                                           
  vlogan +v2k           "$QSYS_SIMDIR/submodules/nios_system_video_dual_clock_buffer_0.v"                             -work video_dual_clock_buffer_0                                                        
  vlogan +v2k           "$QSYS_SIMDIR/submodules/nios_system_video_rgb_resampler_0.v"                                 -work video_rgb_resampler_0                                                            
  vlogan +v2k           "$QSYS_SIMDIR/submodules/nios_system_video_pixel_buffer_dma_0.v"                              -work video_pixel_buffer_dma_0                                                         
  vlogan +v2k           "$QSYS_SIMDIR/submodules/nios_system_new_sdram_controller_0_test_component.v"                 -work new_sdram_controller_0                                                           
  vlogan +v2k           "$QSYS_SIMDIR/submodules/nios_system_new_sdram_controller_0.v"                                -work new_sdram_controller_0                                                           
  vlogan +v2k           "$QSYS_SIMDIR/submodules/nios_system_jtag_uart_0.v"                                           -work jtag_uart_0                                                                      
  vlogan +v2k           "$QSYS_SIMDIR/submodules/nios_system_nios2_qsys_0.vo"                                         -work nios2_qsys_0                                                                     
  ...
  vlogan +v2k           "$QSYS_SIMDIR/submodules/nios_system_nios2_qsys_0_mult_cell.v"                                -work nios2_qsys_0                                                                     
